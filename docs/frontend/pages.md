...
| `/dashboard/charts` | `charts/page.tsx` | Advanced charting | `/api/candles`, `/api/indicators`, `/ws/realtime/{symbol}` |
...
| `/dashboard/ai-signals` | `ai-signals/page.tsx` | AI predictions + sentiment | `/api/predictions/{symbol}`, `/api/patterns/{symbol}`, `/api/anomalies/{symbol}` |
...
| `/dashboard/watchlist` | `watchlist/page.tsx` | Symbol watchlist | `/api/watchlist` |
