...
export function Strategy() {
  return (
    <section id="strategy" className="py-16 sm:py-20 px-4 sm:px-6">
            ...
            <div>
              ...
              <div className="space-y-3">
                  ...
                  return (
                    <div key={lvl.pct} className="space-y-1">
                      ...
                      <div className="h-1.5 rounded-full bg-muted overflow-hidden">
                        <div
                          className={`h-full rounded-full ${isTriggered ? "bg-signal-green" : "bg-border"}`}
                ...
                <p className="text-xs text-muted-foreground pt-1">
                  ● Current: <span className="text-signal-amber">−7.9% from ATH</span> · No entry levels triggered yet
                </p>
              </div>
            </div>
          </AnimateIn>
